...
Atualizado em: **2026-04-20** (pós-PR-054 / D-065 — guard de customer takeover em /api/checkout e /api/agendar/reserve).
...
**Estado dos demais ALTOs:** fechados também 22.1 (ViaCEP), 22.2 (leads DoS), 13.1 (fetchWithTimeout — PR-042), **11.1 (Next bump + CVE-2025-29927 fix — PR-041)**, **13.2 (circuit breaker — PR-050)**, **5.5 (reconciliação pós-clawback — PR-051)**, **5.12 (asaas_events retention + PII redact — PR-052)**, **5.6 (checkout consent persistido — PR-053)**, **3.5 / 3.6 / 5.8 (customer takeover guard — PR-054)**, LGPD 6.3/6.4/17.3/Art. 16. 14.1 foi rebaixado pra 🟡 PARCIAL pela D-057. Pendente único de ALTO não-AI: **17.4 (signed URL log)**.
