/**
 * /admin/financeiro/conciliacao — Conciliação contábil (D-037, movido
 * em D-045 · 3.F pra dar lugar ao dashboard financeiro unificado em
 * `/admin/financeiro`).
 *
  ...
  return (
    <div>
      ...
      <section className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        ...
        <Card
          label="Rodado em"
          value={formatTimeBR(report.runAt)}
