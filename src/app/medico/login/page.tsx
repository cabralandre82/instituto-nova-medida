...
export const metadata: Metadata = {
  title: "Entrar · Área da médica · Instituto Nova Medida",
...
export default async function DoctorLoginPage({
  ...
  const nextPath = sp.next ?? "/medico";
  const sentEmail = sp.sent;

  const errorMessage = (() => {
    switch (errorKey) {
      case "forbidden":
        return "Esta conta não tem perfil de médica.";
      case "no_profile":
        return "Sua conta foi criada mas o perfil ainda não foi finalizado. Fale com o operador.";
      case "expired":
